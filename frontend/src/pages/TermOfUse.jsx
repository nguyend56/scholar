...
import termOfUsePic from "../pictures/termOfUsePic2.jpeg";
  ...
  return (
    <div
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${termOfUsePic})`,
      ...
      <div
        ...
        <h1>TERM OF USE CONTENTS</h1>
        <ol style={{ whiteSpace: "break-spaces" }}>
          <li>
            {" "}
          ...
          <li>
            {" "}
            <a href="#7">7. THIRD-PARTY WEBSITES AND CONTENT</a>
          </li>
          <li>
            {" "}
            <a href="#8">8. SERVICES MANAGEMENT</a>
          </li>
          <li>
            {" "}
          ...
          <li>
            {" "}
            <a href="#10">10. TERM AND TERMINATION</a>
          </li>
          <li>
            {" "}
            <a href="#11">11. MODIFICATIONS AND INTERRUPTIONS</a>
          </li>
          <li>
            {" "}
            <a href="#12">12. GOVERNING LAW</a>
          </li>
          <li>
            {" "}
            <a href="#13">13. DISPUTE RESOLUTION</a>
          </li>
          <li>
            {" "}
            <a href="#14">14. CORRECTIONS</a>
          </li>
          <li>
            {" "}
            <a href="#15">15. DISCLAIMER</a>
          </li>
          <li>
            {" "}
            <a href="#16">16. LIMITATIONS OF LIABILITY</a>
          </li>
          <li>
            {" "}
            <a href="#17">17. INDEMNIFICATION</a>
          </li>
          <li>
            {" "}
            <a href="#18">18. USER DATA</a>
          </li>
          <li>
            {" "}
            <a href="#19">
              19. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURESS
            </a>
          </li>
          <li>
            {" "}
            <a href="#20">20. CALIFORNIA USERS AND RESIDENTS</a>
          </li>
          <li>
            {" "}
            <a href="#21">21. MISCELLANEOUS</a>
          </li>
          <li>
            {" "}
            <a href="#22">22. CONTACT US</a>
          </li>
        </ol>
        <h2 id="1">1. OUR SERVICES</h2>
        <p>
        ...
        <h2 id="2">2. INTELLECTUAL PROPERTY RIGHTS</h2>
        <p>
          ...
          <p>
            ...
            to: nguyend@union.edu. If we ever grant you the permission to post,
          ...
          <p>
            ...
            content through the Services. Submissions: By directly sending us
            ...
            you. You are responsible for what you post or upload: By sending us
        ...
        <h2 id="3">3. USER REPRESENTATIONS</h2>
        <p>
          ...
          <div>
            (4) you will not use the Services for any illegal or unauthorized
            purpose; and{" "}
          </div>
          <div>
        ...
        <h2 id="4">4. PROHIBITED ACTIVITIES</h2>
        <p>
          ...
          <div>- Sell or otherwise transfer your profile.</div>
        </p>
        <h2 id="5"> 5. USER GENERATED CONTRIBUTIONS</h2>
        <p>
        ...
        <h2 id="6"> 6. CONTRIBUTION LICENSE</h2>
        <p>
          ...
          any area on the Services. You are solely responsible for your
        ...
        <h2 id="7"> 7. THIRD-PARTY WEBSITES AND CONTENT</h2>
        <p>
        ...
        <h2 id="8"> 8. SERVICES MANAGEMENT</h2>
        <p>
        ...
        <h2 id="9"> 9. PRIVACY POLICY</h2>
        <p>
          We care about data privacy and security. Please review our Privacy
          Policy:
          <a
            href="https://app.termly.io/dashboard/website/31b131b6-5852-4676-b284-1b8a4abbdbe4/privacy-policy"
            target="_blank"
            rel="noopener noreferrer">
            https://app.termly.io/dashboard/website/31b131b6-5852-4676-b284-1b8a4abbdbe4/privacy-policy
          </a>
        ...
        <h2 id="10"> 10. TERM AND TERMINATION</h2>
        <p>
        ...
        <h2 id="11"> 11. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p>
        ...
        <h2 id="13"> 13. DISPUTE RESOLUTION</h2>
        <p>
          ...
          <p>
            ...
            arbitration will take place in United States, New York. Except as
            ...
            the arbitrator. If for any reason, a Dispute proceeds in court
            rather than arbitration, the Dispute shall be commenced or
            prosecuted in the state and federal courts located in United States,
            New York, and the Parties hereby consent to, and waive all defenses
            ...
            Transaction Act (UCITA) are excluded from these Legal Terms. If this
        ...
        <p>
          ...
          <div>
            ...
            CONTENT POSTED, wTRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE
            SERVICES.
          </div>{" "}
        </p>
        ...
        <h2 id="16"> 16. LIMITATIONS OF LIABILITY</h2>
        <p>
        ...
        <h2 id="17"> 17. INDEMNIFICATION</h2>
        <p>
        ...
        <h2 id="20"> 20. CALIFORNIA USERS AND RESIDENTS</h2>
        <p>
        ...
        <h2 id="22"> 22. CONTACT US</h2>
        <p>
          In order to resolve a complaint regarding the Services or to receive
          further information regarding use of the Services, please contact us
          at:
          <div>Union College </div>
          <div>807 Union St. </div>
          <div>Schenectady </div>
          <div>NY 12308 </div>
          <div>United States</div>
          <div>Phone: +1 (518) 986-1012 </div>
          <div>nguyend@union.edu</div>
        </p>
        <BackToTop />
      </div>
    </div>
